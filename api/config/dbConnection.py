...
db_pool = DBPool(os.getenv('DATABASE_URL', 'postgresql://neondb_owner:npg_rNbUM3kWw0ZB@ep-green-forest-a5wzvqzd-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require'))
